  ...
  <jsp:include page="../nav.jsp"></jsp:include>
    	<div class="container"
			...
			<input type="hidden" name="fun" value="Resign">
				...
				查询结果：
				<d:table class="table table-striped" id="formResign" name="${sessionScope['list']}" size="${sessionScope['total']}" 
				partialList="true" export="true" pagesize="${initParam.pageSize}" requestURI="/servlet/formResginServlet" >
