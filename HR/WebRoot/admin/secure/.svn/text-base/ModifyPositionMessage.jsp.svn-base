...
<body>
	...
	<form class="form-horizontal" role="form" method="post" action="">
				<div class="row">
					...
					岗位编号：<label class="control-label">1</label>
						</div>
					</div>
				</div>
				<div class="row">
					...
					<div class="col-md-5 col-md-offset-1">
						<div class="form-group">
							岗位类型
							<input type="text" name="textfield4" class="form-control" />
						</div>
					</div>
				</div>
				<div class="row">
					<div class="col-md-5 ">
						<div class="form-group">
							岗位编制
							<input type="text" name="textfield5" class="form-control" />
						</div>
					</div>
				</div>
					<div class="row">
						<div class="col-md-2 col-md-offset-3" >
							<div class="form-group">
								<button type="button" class="btn btn-info btn-lg btn-block">修改</button>
							</div>
						</div>
