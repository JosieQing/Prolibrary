...
<!--导航部分 -->
<tr>
<td colspan="4"><a style="align:left;"href="main.jsp">主页</a><div  style="text-align:center;"><font style="color:deepskyblue;font-size:30px"><b>客观题答案</b></font></div></td>
</tr>
<!--导航结束 -->
<%
...
<tr>
<td colspan="4">
<form class=" form-inline" action="answerListKg.jsp">
...
<tr>
<td><font color="pink" font-size="large"><b>序号</b></font></td>
<td><font color="pink" font-size="large"><b>题目</b></font></td>
<td><font color="pink" font-size="large"><b>答案</b></font></td>
<td><font color="pink" font-size="large"><b>操作</b></font></td>
</tr>
<%
int rowTotal=0;
int pageTotal=0;
...
answerBean ab=new answerBean();
	...
	List rList = ab.getKgAnswerList(query_subject,rowIndex,pu.getPageSize());
	for(int i=0;i<rList.size();i++){
		answerObj ao = (answerObj)rList.get(i);//
		String kg_id = ao.getKg_id();
		//out.print(kg_id);
		String subject = ao.getSubject();
		String kg_answer= ao.getKg_answer();
%>
<tr>
<td><%=(i+1) %></td>
<td><%=subject%></td>
<td><%=kg_answer%></td>
<td>
<a href="answer_updateKg.jsp?kg_id=<%=kg_id%>&curp=<%=currentPage%>">修改</a>
</td>
</tr>
<%
	}
...
<td colspan="4">
<%
String page_location="answerListKg.jsp";
%>
